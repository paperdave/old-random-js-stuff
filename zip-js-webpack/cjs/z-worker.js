/* This version of z-worker.js is modified by Dave Caruso to work as a CommonJS
 * Module, for use in Webpack or another module bundler.
 */
var worker = function main(global) {
	"use strict";
...
// CJS MOD: Export String
module.exports = `(${worker.toString()})(this)`;
